...
BEGIN;
/* CAMBODIA */
INSERT INTO `starter_category` VALUES (128,'NodeJS + Mongo-DB App template','starter_main','NodeJS + Mongo-DB App template','NodeJS 앱 개발 환경과 No-SQL Mongo DB 서비스를 사용하여 애플리케이션을 개발합니다.','Node+mongodb.png','http://10.30.131.12:10008/v1/KEY_65a45a92376949e2a756e511e0d92d2b/portal-container/0d169298733b4cd0b73b270940b6d31c.png','N','admin','2016-07-20 14:55:42','2022-02-03 01:58:14','{\"paas-ta\":\"colors6\",\"free\":\"colors1\"}'),(9609,'eGov Framework Web Application Template','starter_main','eGov Framework Web Application Template','전자정부 프레임워크 앱 개발 환경과 함께 Mysql DB 서비스를 사용하고 Redis 및 Object 저장소를 사용합니다.','전자정부프레임워크빌드팩.png','http://10.30.131.12:10008/v1/KEY_65a45a92376949e2a756e511e0d92d2b/portal-container/7272c77bc5234267b2b7e22bbbb0525a.png','N','admin','2016-08-22 07:18:29','2022-02-03 01:57:52','{\"paas-ta\":\"colors6\",\"free\":\"colors1\"}'),(127,'Java + Redis App template','starter_main','Java + Redis App template','자바8 Tomcat 앱 개발 환경과  Redis DB  서비스로 애플리케이션을 개발합니다.','redis???.jpg','http://10.30.107.112:10008/v1/KEY_28ffd3f738074f298c68de2e40c76d35/portal-container/c8baf82926c147c0b7e18ff403232e61-1537434189535-cmVkaXM_Pz8uanBn','N','admin','2016-07-20 14:54:38','2022-02-03 01:58:53','{\"paas-ta\":\"colors6\",\"free\":\"colors1\"}'),(31937,'Java default type app template','starter_main','Java and MySQL based web application execution environment template','Java와 MySQL 기반 웹 애플리케이션 실행환경입니다. \n','??8.jpg','http://10.0.1.121:10008/v1/AUTH_e5ce8ad365f84c509684e3061ba715ad/portal-container/2ff6f29f5eb14e6a9aee9f84da5b849c-1643849432359-Pz84LmpwZw%3D%3D','N','admin','2016-11-09 01:06:29','2022-02-03 00:51:03','{\"paas-ta\":\"colors6\",\"free\":\"colors1\"}');
/* CAMBODIA */
COMMIT;
