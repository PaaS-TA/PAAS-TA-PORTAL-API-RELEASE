...
INSERT INTO `code_detail` VALUES (214,'cp_portal','cp_portal','Container Platform Portal 서비스',18,'Y',14,'admin','2022-05-19 17:34:00','2022-05-19 17:34:00','ko');
...
INSERT INTO `code_detail` VALUES (414,'cp_portal','cp_portal','Container Platform Portal Service',118,'Y',14,'admin','2022-05-19 17:34:00','2022-05-19 17:34:00','en');
...
INSERT INTO `servicepack_category` VALUES (37920,'Container Platform Portal 서비스','dev_ops','Container Platform Portal 서비스','<h1>Container Platform Portal Service Broker for PaaS-TA</h1>\n\n<p>Container Platform Portal 서비스 브로커는 컨테이너 플랫폼 포털을 파스-타(PaaS-TA) 서비스로 제공합니다.</p>\n\n<p>이 서비스 브로커는 쿠버네티스(Kubernetes)에 대응하고 있으며, 클라우드 컨트롤러와 서비스 브로커 간의 v2 서비스 API를 보여줍니다. 이 API는 클라우드 컨트롤러 API와 혼동되어서는 안됩니다.</p>\n\n<p>이 브로커에는 컨테이너 플랫폼 포털 서버의 서비스를 관리하는 Container Platform Portal 자바 브로커를 배포하는 것을 의미합니다.</p>\n\n<p>Container Platform Portal 서비스 브로커는 컨테이너 플랫폼 포털 서버와 PaaS-TA(클라우드 파운드리)간의 서비스를 제공하는 것을 말하며, 독립 실행하여 실행되는 컨테이너 플랫폼 포털 서버 응용프로그램은 별도로 지원하지 않습니다.</p>\n\n<p>이 브로커가 수행하는 컨테이너 플랫폼 포털 관리 작업은 다음과 같습니다.</p>\n\n<ul>\n    <li>컨테이너 플랫폼 포털 서비스의 카탈로그 등록</li>\n   <li>컨테이너 플랫폼 포털 인스턴스\n 프로비저닝 생성</li>\n    <li>컨테이너 플랫폼 포털 인스턴스 프로비저닝 해제</li>\n</ul>\n  이 브로커에서는 컨테이너 플랫폼 포털 서비스에 대한 바인딩/언바인딩은 제공하지 않습니다.&nbsp;<a href=\"https://github.com/PaaS-TA/Documents-PaaSTA-1.0/blob/master/Development-Guide/ServicePack_develope_guide.md\">서비스팩 개발 가이드</a>의 API 개발 가이드를 참고하시면 아키텍쳐와 기술, 구현과 개발에 대해 자세히 알 수 있습니다.','NONE','caas.png','http://10.30.107.212:10008/v1/KEY_004c50822d764bf5aca77e7ebf454d56/portal-container/9aa14ac5bdb242abb5bbfe2ff5819f2c-1540343318325-Y2Fhcy5wbmc%3D','N','admin','2018-08-17 05:26:01','2021-12-07 02:28:43','{\"owner\":\"default\",\"org_name\":\"default\",\"space_name\":\"default\"}','{}','Y','N','https://github.com/PaaS-TA/container-platform-portal-service-broker','{\"paas-ta\":\"colors6\",\"free\":\"colors2\"}','N',3,214,'ko');
...
INSERT INTO `servicepack_category` VALUES (38920,'Container Platform Portal Service','dev_ops','Container Platform Portal Service','<h1>Container Platform Portal Service Broker for PaaS-TA</h1>\n\n<p>The Container Platform Portal Service Broker provides the Container Platform Portal as a PaaS-TA service.</p>\n\n<p>This service broker is Kubernetes-aware and exposes the v2 service API between Cloud Controller and Service Broker. This API should not be confused with the Cloud Controller API.</p>\n\n<p>In this broker we mean deploying the Container Platform Portal Java Broker, which manages the services of the Container Platform Portal Server.</p>\n\n<p>The Container Platform Portal Service Broker provides services between the Container Platform Portal Server and PaaS-TA (Cloud Foundry), and does not support the standalone Container Platform Portal Server application.</p>\n\n<p>Container platform portal tasks performed by this broker include:</p>\n\n<p>ㆍ Catalog Registration of Container Platform Portal Service<br />\nㆍ Create Container Platform Portal Instance Provisioning<br />\nㆍ  Deprovisioning Container Platform Portal Instance</p>\n\n<p>This broker does not provide binding/unbinding to the Container Platform Portal service. If you refer to the API development guide in the <a href=\"https://github.com/PaaS-TA/Documents-PaaSTA-1.0/blob/master/Development-Guide/ServicePack_develope_guide.md\">Service Pack Development Guide</a>, you can learn more about the architecture, technology, implementation and development.</p>\n','NONE','caas.png','http://10.30.107.212:10008/v1/KEY_004c50822d764bf5aca77e7ebf454d56/portal-container/9aa14ac5bdb242abb5bbfe2ff5819f2c-1540343318325-Y2Fhcy5wbmc%3D','N','admin','2018-08-17 05:26:01','2022-02-03 02:31:33','{\"owner\":\"default\",\"org_name\":\"default\",\"space_name\":\"default\"}','{}','Y','N','https://github.com/PaaS-TA/container-platform-portal-service-broker','{\"paas-ta\":\"colors6\",\"free\":\"colors2\"}','N',103,414,'en');
